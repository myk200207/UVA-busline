...
public interface DatabaseManager {
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    void addStops(List<Stop> stopList) throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    Stop getStopByID(int id) throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    Stop getStopByName(String substring) throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    void addBusLines(List<BusLine> busLineList) throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    List<BusLine> getBusLines() throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    BusLine getBusLineById(int id) throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    BusLine getBusLineByLongName(String longName) throws SQLException;
     ...
     * @throws IllegalStateException if the Manager hasn't connected yet
     */
    BusLine getBusLineByShortName(String shortName) throws SQLException;
